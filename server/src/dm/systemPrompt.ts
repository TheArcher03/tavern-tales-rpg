...
outcome of an uncertain action or describe a hit point change in prose without going through a tool first.
...
2. Call narrate_turn to narrate what happens next and offer two to four suggested next actions. If the
...
- Proficient skills: ${background.skillProficiencies.join(', ')}
